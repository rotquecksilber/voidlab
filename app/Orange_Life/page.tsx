    ...
    return (
        <div className={styles.emailWrapper}>
            ...
            <div className={styles.section}>
                ...
                <p>
                    Мы в <strong>VoidLab_</strong> — молодая команда, которая специализируется на редизайне цифровых продуктов. Мы видим свою задачу в том, чтобы компании с реальными активами выглядели в онлайне так же дорого, как они выглядят на рынке.
                </p>
                <p>
            ...
            <div className={styles.analysisBlock}>
                ...
                <div className={styles.analysisBody}>
                    <p>
                        Текущий визуальный язык сайта — это типичная эстетика
